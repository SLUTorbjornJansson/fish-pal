...
*   H�rdkodat antagande om att variansen av PMP-kostnaden/int�kten �r proportionell
*   mot den f�r variabla kostnader per dag.
*   Detta �r rimligt p� s� vis att det �r proportionellt mot oms�ttningen i fisket,
*   och inte samma f�r tr�lare och sm� kustfisken
...
*   Landningar: Vikten f�r normalf�rdelningen �r 1/(2*variansen). H�r har vi �kat vikten med en faktor tio.
...
*   Vikten f�r normalf�rdelningen �r 1/(2*variansen).
...
*   Steg 1: hitta en startpunkt (s�rskilt f�r komplementaritetsvillkoren!)
*           �ver huvud taget genom att l�sa den primala modellen
*
*   Steg 2: g�r en snabb optimering av skattningen, som bara ger en approximation.
*
*
*###############################################################################
...
*   Oavsett hur tung kavel man har, s� finns det lika mycket deg...
...
*   --- F�r att hitta en bra startpunkt till MINLP-problemet (som l�ses med BARON),
*       s� g�r vi f�rst en approximation, d�r vi introducerar komplementaritesvillkoren
*       stegvis. F�rst till�ter vi att x*y < my (om x > 0 och y > 0 �r variabler), och l�ter
*       s� my g� fr�n ett stort positivt tal mot noll. N�r my = 0 s� �r komplementaritetsvillkoren
*       exakt uppfyllda. Denna algoritm, hur stort my �r fr�n b�rjan, etc, m�ste provas in manuellt.
...
* --- Check if we get an identical solution with penalty function and mu=0
    ...
    m_estimateFish.SOLPRINT = 2;
    SOLVE m_estimateFish USING NLP MAXIMIZING v_estimationMetric;
    DISPLAY "Initial try med penalty, my=0 (initierad av f�rra l�sningen): ", v_estimationMetric.L;
);
...
*   Rapportera m�lfunktionens v�rde
...
*   Aggregera fishery till segment etc, men bara f�r aggregaten, inte f�r enskilda fishery
