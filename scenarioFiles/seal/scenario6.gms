...
$batinclude "scenarioFiles\scenarioComponents\change_costs_by_x_percent.gms"  (-75)

* --- change in catch for seal affected DAS
*     The "50" after the include shows up in the batinclude file as "%1", used to change catch.
$batinclude "scenarioFiles\scenarioComponents\change_catch_by_x_percent.gms" 75

* --- Change total budget for seal damage compensation, percent compared to previous value
$batinclude "scenarioFiles\scenarioComponents\change_subsidy_budget_by_x_percent.gms" (-75)
